...
export default function EditCustomerPage() {
  ...
  function handleSave() {
    ...
    alert(`Customer ${id ? id : 'updated'} successfully!`)
        ...
        <div className="overflow-hidden rounded-xl border border-line bg-card shadow-xs">
          ...
          <div className="border-b border-line px-6 py-4">
            ...
            <p className="mt-1 text-xs font-medium text-muted">
              Update customer details below. Fields marked with{' '}
              <span className="text-primary">*</span> are required.
            </p>
            {id && (
              <span className="mt-2 inline-block rounded-md bg-primary/10 px-2 py-0.5 text-[11px] font-bold text-primary">
                ID: {id}
              </span>
            )}
          </div>
