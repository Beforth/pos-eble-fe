...
const SAMPLE_TOPUP_LOGS: CashTopUpLogEntry[] = [
  {
    id: 'ctl-1',
    dateTime: '13 Aug 2026 09:00:00',
    amount: 2000,
    paymentSource: 'Owner Cash Deposit',
    updateType: 'Created',
    remarks: 'Opening floating cash top-up for biller register',
    performedBy: 'Amit Thakkar',
  },
  {
    id: 'ctl-2',
    dateTime: '12 Aug 2026 15:30:00',
    amount: 1500,
    paymentSource: 'Manager Float',
    updateType: 'Updated',
    remarks: 'Mid-day register cash replenishment',
...
export default function CashTopUpLogsPage() {
  ...
  function handleSearch() {
    ...
    if (updateType === 'All') {
      ...
      setLogs(SAMPLE_TOPUP_LOGS.filter((l) => l.updateType === updateType))
    }
  ...
  return (
    <ReportsPageShell
      title="Cash Top-Up Logs"
      activeItem="user-logs-cash-topup"
    >
      {toast ? (
                ...
                <tbody className="divide-y divide-line">
                  {logs.map((l) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-muted">{l.paymentSource}</td>
