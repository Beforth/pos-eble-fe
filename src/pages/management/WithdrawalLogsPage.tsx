...
const SAMPLE_WITHDRAWAL_LOGS: WithdrawalLogEntry[] = [
  {
    id: 'wl-1',
    dateTime: '13 Aug 2026 11:00:00',
    amount: 5000,
    paymentMethod: 'Bank Transfer (HDFC)',
    updateType: 'Created',
    remarks: 'Owner cash withdrawal for vendor settlement',
    performedBy: 'Amit Thakkar',
  },
  {
    id: 'wl-2',
    dateTime: '11 Aug 2026 19:30:00',
    amount: 3200,
    paymentMethod: 'Cash Box',
    updateType: 'Updated',
    remarks: 'Emergency petty cash withdrawal logged',
...
export default function WithdrawalLogsPage() {
  ...
  function handleSearch() {
    ...
    if (updateType === 'All') {
      ...
      setLogs(
        SAMPLE_WITHDRAWAL_LOGS.filter((l) => l.updateType === updateType),
      )
    }
              ...
              <table className="w-full text-left text-sm text-ink">
                <thead className="border-b border-line bg-page text-xs font-semibold uppercase tracking-wider text-muted">
                  <tr>
                    ...
                    <th className="px-4 py-3">Withdrawal Amount (₹)</th>
                ...
                <tbody className="divide-y divide-line">
                  {logs.map((l) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-muted">{l.paymentMethod}</td>
