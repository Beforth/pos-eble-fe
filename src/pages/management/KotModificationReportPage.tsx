...
const SUMMARY_STATS = [
  {
    label: 'Total KOTs Modified',
    amount: '0',
    subtext: '0 orders',
  },
  {
    label: 'Total KOTs Cancelled',
    amount: '0',
    subtext: '0 orders',
  },
  {
    label: 'Total Amount Affected',
    amount: '0.00',
    subtext: null,
  },
]
  ...
  return (
    <AuditTrailPageShell activeItem="kot-modification-report">
      <div className="space-y-6">
          ...
          {SUMMARY_STATS.map((stat) => (
            ...
            >
              ...
              <span className="text-lg font-bold tabular-nums text-ink">
                {stat.label.includes('Amount') ? `₹${stat.amount}` : stat.amount}
              </span>
              {stat.subtext ? (
        ...
        {/* Empty State */}
        <div className="flex min-h-[420px] flex-col items-center justify-center rounded-xl border border-line bg-card p-8 text-center shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          <div className="flex size-14 items-center justify-center rounded-full border border-line bg-page text-muted">
            <AlertCircle size={28} />
          </div>
