...
const ORDER_STATUS_OPTIONS = ['All', 'Success', 'Pending', 'Failed']

export default function ItemWiseAllRestaurantsReport() {
  ...
  function handleExport() {
    showToast('Preparing ZIP download… This might take some time.')
  }
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-sm text-muted">
        Note : Once you click on Export, Zip file will download automatically.
