...
export default function OrderSummaryCorporateCustomers() {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-[280px] items-center justify-center rounded-xl border border-line bg-card px-6 py-16">
        <p className="text-base font-semibold text-ink">
          {searched ? 'No Record Found' : 'Search to view corporate orders'}
        </p>
      </div>
    </ReportsPageShell>
  )
