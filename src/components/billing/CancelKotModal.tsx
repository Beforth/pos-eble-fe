...
export function CancelKotModal({
  open,
  kotNo,
  onClose,
  onConfirm,
      ...
      >
        ...
        <div className="px-5 py-4">
          <label className="block text-sm font-medium text-ink">
            ...
            <textarea
              ...
              rows={4}
              autoFocus
              className={`mt-2 w-full rounded-md border px-3 py-2 text-sm text-ink outline-none focus:border-primary ${
        ...
        <footer className="flex justify-end gap-2 border-t border-line px-5 py-3">
          <button
            type="button"
            onClick={onClose}
            className="h-9 rounded-lg border border-ink/70 bg-white px-4 text-sm font-medium text-ink hover:bg-page"
          >
            Cancel
          </button>
          <button
